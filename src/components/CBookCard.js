...
export default function CSlider(props) {
    const { name, author, rating, description = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus excepturi natus consequuntur labore quis impedit, id omnis quam aliquam hic fugiat aperiam perspiciatis accusantium ullam ab laborum! Quisquam, ad labore.", image, reaction } = props
    ...
    return (
        <div className="shadow bg-white w-full">
            <div className="flex">
                ...
                <div className="p-4" style={{ width: 'calc(100% - 160px - 3.5rem)' }}>
